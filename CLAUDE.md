...
| **⑥** design system | le **WCO** n'a jamais été rendu ; `--accent-fenetre` **n'est déclaré nulle part et peint par rien** ; `client/src/design/tokens.css` est à **300/300, marge nulle**, avec **treize** lecteurs qui le nomment par son chemin (relevé de la tâche 6, `docs/superpowers/sdd/2026-08-22-legs-sans-vm/task-6-report.md` — « onze » et « 33 » étaient tous deux vrais de choses différentes, faute de règle énoncée) ; les galeries n'ont **aucun test** |
