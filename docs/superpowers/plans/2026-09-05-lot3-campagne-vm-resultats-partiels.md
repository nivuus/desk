...
> 🔴 **CE DOCUMENT NE CLÔT PAS LE LOT.** Six items sur douze portent un chiffre
> daté ; six n'ont pas été joués. Écrire « lot 3 clos » serait faux, et le § 5
...
## 2. Les six items qui portent un chiffre
...
## 5. Ce qui reste dû — six items, et les moitiés manquantes des autres

| Item | Ce qui reste |
| --- | --- |
| **1 (3.7)** « temporaire + renommage » sur un éditeur réel | **entier, non joué** — le seul item dont l'échec perdrait des données |
