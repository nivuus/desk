// Point d'entrée du service : une seule lecture d'environnement, un serveur,
// un arrêt propre.
//
...
import { demarrerServeur } from './http/serveur';

const config = lireConfig(process.env);
const service = await demarrerServeur(config);
