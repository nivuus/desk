...
const SECRET_VM = 'un-secret-d-enrolement-de-la-vraie-longueur';
...
async function enrolerUneVm(p: Pilote, vmId: string): Promise<void> {
...
function ouvrirUrl(url: string): Promise<Pair> {
...
function ouvrir(port: number): Promise<Pair> {
